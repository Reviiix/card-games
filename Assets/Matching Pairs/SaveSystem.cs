...
public static class SaveSystem
{
    ...
    private const bool SaveWithBinaryFormatter = true;
    ...
    {
        SaveFile = SaveWithBinaryFormatter ? LoadClassFromBinaryFormatter<SaveData>(FilePath) : LoadClassFromJSON<SaveData>(FilePath);
        callBack?.Invoke();
    }
